...
CALL F_ilwderivative%GET_DEVICE_DATA_RDWR(P_ilwderivative)
CALL F_iswdirectband%GET_DEVICE_DATA_RDWR(P_iswdirectband)
CALL F_iswdiffuseband%GET_DEVICE_DATA_RDWR(P_iswdiffuseband)
...
!$ACC    & PRESENT( &
!$ACC           & NFLEVG, KAEROSOL, PSOLAR_IRRADIANCE, &
...
!$ACC & PRIVATE(SINGLE_LEVEL,THERMODYNAMICS,GAS,YLCLOUD,AEROSOL,FLUX)
DO JKGLO=1,NGPTOT,NRPROMA
    KIDIA=1
    KFDIA=MIN(NRPROMA,NGPTOT-JKGLO+1)
    IBL=(JKGLO-1)/NRPROMA+1
