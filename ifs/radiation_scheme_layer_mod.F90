...
USE RADIATION_CONFIG,               ONLY: ISolverMcICA
...
! Whether McICA solver needs iseed
LOGICAL :: LUSE_MCICA_SEED
...
! Determine if McICA solver needs iseed
LUSE_MCICA_SEED = (RAD_CONFIG%I_SOLVER_SW == ISolverMcICA &
     &        .OR. RAD_CONFIG%I_SOLVER_LW == ISolverMcICA)

CALL SINGLE_LEVEL_FIELD%INIT(NBLKS, NRPROMA, YRADIATION%YRERAD%NSW, YRADIATION%YRERAD%NLWEMISS, &
     &                      USE_SW_ALBEDO_DIRECT=.TRUE., USE_MCICA=LUSE_MCICA_SEED, ISEED=ISEED)
...
CALL SINGLE_LEVEL_FIELD%INIT(NBLKS, NRPROMA, YRADIATION%YRERAD%NSW, YRADIATION%YRERAD%NLWEMISS, &
     &                      USE_SW_ALBEDO_DIRECT=.TRUE., ON_GPU=.TRUE., USE_MCICA=LUSE_MCICA_SEED, ISEED=ISEED)
CALL SINGLE_LEVEL_FIELD%UPDATE_SINGLE_LEVEL(SINGLE_LEVEL)
...
CALL SGET_DEVICE_DATA_RDONLY(P_iamu0,F_iamu0)
CALL SGET_DEVICE_DATA_RDONLY(P_iemiss,F_iemiss)
CALL SGET_DEVICE_DATA_RDONLY(P_its,F_its)
CALL SGET_DEVICE_DATA_RDONLY(P_islm,F_islm)
CALL SGET_DEVICE_DATA_RDONLY(P_iccnl,F_iccnl)
CALL SGET_DEVICE_DATA_RDONLY(P_iccno,F_iccno)
CALL SGET_DEVICE_DATA_RDONLY(P_igelam,F_igelam)
CALL SGET_DEVICE_DATA_RDONLY(P_igemu,F_igemu)
CALL SGET_DEVICE_DATA_RDONLY(P_iald,F_iald)
CALL SGET_DEVICE_DATA_RDONLY(P_ialp,F_ialp)
CALL SGET_DEVICE_DATA_RDONLY(P_iti,F_iti)
CALL SGET_DEVICE_DATA_RDONLY(P_ipr,F_ipr)
CALL SGET_DEVICE_DATA_RDONLY(P_iwv,F_iwv)
CALL SGET_DEVICE_DATA_RDONLY(P_iclc,F_iclc)
CALL SGET_DEVICE_DATA_RDONLY(P_ilwa,F_ilwa)
CALL SGET_DEVICE_DATA_RDONLY(P_iiwa,F_iiwa)
CALL SGET_DEVICE_DATA_RDONLY(P_iswa,F_iswa)
CALL SGET_DEVICE_DATA_RDONLY(P_irwa,F_irwa)
IF(lrayfm) CALL SGET_DEVICE_DATA_RDONLY(P_ioz,F_ioz)
CALL SGET_DEVICE_DATA_RDONLY(P_iaprs,F_iaprs)
CALL SGET_DEVICE_DATA_RDONLY(P_ihti,F_ihti)
CALL SGET_DEVICE_DATA_RDONLY(P_ire_liq,F_ire_liq)
CALL SGET_DEVICE_DATA_RDONLY(P_ire_ice,F_ire_ice)
CALL SGET_DEVICE_DATA_RDONLY(P_ioverlap,F_ioverlap)

CALL SGET_DEVICE_DATA_RDWR(P_iaero,F_iaero)
CALL SGET_DEVICE_DATA_RDWR(P_ifrsod,F_ifrsod)
CALL SGET_DEVICE_DATA_RDWR(P_ifrted,F_ifrted)
CALL SGET_DEVICE_DATA_RDWR(P_ifrsodc,F_ifrsodc)
CALL SGET_DEVICE_DATA_RDWR(P_ifrtedc,F_ifrtedc)
CALL SGET_DEVICE_DATA_RDWR(P_iemit,F_iemit)
CALL SGET_DEVICE_DATA_RDWR(P_isudu,F_isudu)
CALL SGET_DEVICE_DATA_RDWR(P_iuvdf,F_iuvdf)
CALL SGET_DEVICE_DATA_RDWR(P_iparf,F_iparf)
CALL SGET_DEVICE_DATA_RDWR(P_iparcf,F_iparcf)
CALL SGET_DEVICE_DATA_RDWR(P_itincf,F_itincf)
CALL SGET_DEVICE_DATA_RDWR(P_ifdir,F_ifdir)
CALL SGET_DEVICE_DATA_RDWR(P_icdir,F_icdir)
CALL SGET_DEVICE_DATA_RDWR(P_ilwderivative,F_ilwderivative)
CALL SGET_DEVICE_DATA_RDWR(P_iswdirectband,F_iswdirectband)
CALL SGET_DEVICE_DATA_RDWR(P_iswdiffuseband,F_iswdiffuseband)
CALL SGET_DEVICE_DATA_RDWR(P_ifrso,F_ifrso)
CALL SGET_DEVICE_DATA_RDWR(P_iswfc,F_iswfc)
CALL SGET_DEVICE_DATA_RDWR(P_ifrth,F_ifrth)
CALL SGET_DEVICE_DATA_RDWR(P_ilwfc,F_ilwfc)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_iaer,F_iaer)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_ioz,F_ioz)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_iico2,F_iico2)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_iich4,F_iich4)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_iin2o,F_iin2o)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_ino2,F_ino2)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_ic11,F_ic11)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_ic12,F_ic12)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_ic22,F_ic22)
IF(ldiagforcing) CALL SGET_DEVICE_DATA_RDWR(P_icl4,F_icl4)

IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_iaer,F_iaer)
IF(.not.(ldiagforcing.or.lrayfm)) CALL SGET_DEVICE_DATA_WRONLY(P_ioz,F_ioz)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_iico2,F_iico2)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_iich4,F_iich4)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_iin2o,F_iin2o)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_ino2,F_ino2)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_ic11,F_ic11)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_ic12,F_ic12)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_ic22,F_ic22)
IF(.not.ldiagforcing) CALL SGET_DEVICE_DATA_WRONLY(P_icl4,F_icl4)
...
!$ACC DATA COPYIN(KIDIA, KFDIA, NRPROMA) &
!$ACC    & PRESENT( &
