...
module radiation_single_level
  ...
  type single_level_type
    ...
    ! Shortwave albedo: if sw_albedo_direct is not associated then
    ...
    integer, pointer, contiguous, dimension(:) :: iseed=>null() ! (ncol)
...
contains
  ...
  subroutine init_seed_simple(this, istartcol, iendcol)
    ...
    if (.not. associated(this%iseed)) then
